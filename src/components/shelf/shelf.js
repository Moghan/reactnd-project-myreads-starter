...
const Shelf = ({ booklist, book, addBook }) => {
  const statusList = [
    {
      ...
      <div className="list-books-content">
        ...
        { statusList.map(( status, index ) => (
          <div key={index} className="bookshelf">
            <h2 className="bookshelf-title">{status.description}</h2>
            <div className="bookshelf-books">
              <ol className="books-grid">
              { booklist.filter((book) => book.status === status.name).map((book, index) => (
                <li key={index}>
                  <Book book={book} add={addBook} />
                </li>
              ))}
              </ol>
            </div>
      ...
      <div className="list-books-content">
        <div>
          <div className="bookshelf">
            ...
            <div className="bookshelf-books">
              <ol className="books-grid">
              { booklist.filter((book) => book.status == "currentlyReading").map((book) => (
                <li>
                  <Book book={book} add={addBook} />
                </li>
              ))}
          ...
          <div className="bookshelf">
            ...
            <div className="bookshelf-books">
              <ol className="books-grid">
              { booklist.filter((book) => book.status == "wantToRead").map((book) => (
                <li>
                  <Book book={book} add={addBook} />
                </li>
              ))}
          ...
          <div className="bookshelf">
            ...
            <div className="bookshelf-books">
              <ol className="books-grid">
              { booklist.filter((book) => book.status == "read").map((book) => (
                <li>
                  <Book book={book} add={addBook} />
                </li>
              ))}
